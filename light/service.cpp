...
#define LOG_TAG "android.hardware.light@2.0-service.exynos_7870"
...
const static std::string kLcdBacklightPath = "/sys/class/backlight/panel/brightness";
const static std::string kLcdMaxBacklightPath = "/sys/class/backlight/panel/max_brightness";
